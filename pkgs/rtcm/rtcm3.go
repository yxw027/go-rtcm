...
func NewRtcm3Message(payload []byte) (msg Rtcm3Message) {
    ...
    switch int(messageNumber) {
        ...
        case 1101: return NewRtcm3Message1101(payload)
        case 1102: return NewRtcm3Message1102(payload)
        case 1103: return NewRtcm3Message1103(payload)
        case 1104: return NewRtcm3Message1104(payload)
        case 1105: return NewRtcm3Message1105(payload)
        case 1106: return NewRtcm3Message1106(payload)
        case 1107: return NewRtcm3Message1107(payload)
